...
public class CartRestController {
	...
	@RequestMapping(value = "/{cartId}", method = RequestMethod.GET) //getÀº select
	public ResponseEntity<Cart> getCartById(@PathVariable(value = "cartId") int cartId) {
		Cart cart = cartService.getCartById(cartId);
		return new ResponseEntity<Cart>(cart, HttpStatus.OK);
	}

	@RequestMapping(value = "/{cartId}", method = RequestMethod.DELETE) //delete´Â delete
	...
	@RequestMapping(value = "/add/{productId}", method = RequestMethod.PUT) //putÀº update
